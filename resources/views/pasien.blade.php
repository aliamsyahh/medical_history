                ...
                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                  ...
                  @foreach ($pasiens as $pasien)
                    <tr>
                      ...
                      <td>{{ $pasien->hp }}</td>
                      <td><a href="https://api.whatsapp.com/send?phone={{hp($pasien->hp)}}&text=Halo%20{{$pasien->nama}}%20saya%20ingin%20mengkonfirmasikan%20hasil%20antigen%20sebagai%20berikut" class="btn btn-outline-success btn-sm" target="_blank"><i class="fab fa-whatsapp"></i></a></td>
                      <td>
